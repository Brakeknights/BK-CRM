...
- [ ] Google map click-to-load is intentional and fine for SEO — no action needed (confirmed: crawler never loads iframes; load speed benefit outweighs auto-load; local SEO driven by schema + GBP, not the embed)
